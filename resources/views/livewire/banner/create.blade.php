                ...
                <div class="p-8">
                    <form action="" wire:submit.prevent="store">
                        ...
                        <div class="w-full mb-5">
                            ...
                            <input type="date" wire:model.defer="expire" class="w-full border-gray-300 @error('expire') border-red-700 @enderror">
                            @error('expire')<span class="block mt-1 text-sm text-red-700">{{$message}}</span>@enderror
                        </div>
                        <div class="mb-5">
